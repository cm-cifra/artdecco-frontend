    ...
    async uploadFile() {
      ...
      Papa.parse(this.file, {
        ...
        complete: async (results) => {
          ...
          let dataRows = rawData.slice(1); // Remaining rows as data
          ...
          try {
            ...
            dataRows.forEach((row, index) => {
              ...
              payload.push({
                ...
                product_height: mappedRow.product_height || "",
            ...
            await axios.post("http://localhost:3000/products/bulk", products);
            await axios.post(
              "http://localhost:3000/info_mirror_cabinets/bulk",
              payload
            );
